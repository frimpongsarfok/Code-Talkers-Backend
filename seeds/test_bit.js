...
exports.seed = async function(knex) {
  ...
  await knex('tasks').insert([
    {title:'Data Flow Design',status:1,tags:'Project 1 Data Flow',points:30,product_id:1},
    {title:'Data Structure Design',status:1,tags:'Project 2 Data Flow',points:35,product_id:2},
  ])
